...
func LoadDockerCliFromID(id dagger.DockerCliID) *dagger.DockerCli {
	client := initClient()
	return client.LoadDockerCliFromID(id)
}

// Load a Docker from its ID.
func LoadDockerFromID(id dagger.DockerID) *dagger.Docker {
	client := initClient()
	return client.LoadDockerFromID(id)
}

// Load a DockerImage from its ID.
func LoadDockerImageFromID(id dagger.DockerImageID) *dagger.DockerImage {
	client := initClient()
	return client.LoadDockerImageFromID(id)
}
